  ...
  template: `
    <section class="cta-section">
      ...
      <div class="container cta-section__inner">
        <h2 class="cta-section__title">{{ 'projects.mentebonita.cta.title' | transloco }}</h2>
        <p class="cta-section__desc">
          {{ 'projects.mentebonita.cta.desc' | transloco }}
        </p>
        <div class="cta-section__actions">
          ...
          >
            {{ 'projects.mentebonita.cta.primary' | transloco }}
